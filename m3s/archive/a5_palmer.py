...
class A5PalmerGrid(BaseGrid):
    ...
    def _cell_to_boundary(self, cell: A5CellData, input_lon: float = None, input_lat: float = None) -> List[Tuple[float, float]]:
        ...
        if abs(center_lat) > 85.0:
            ...
            for i in range(5):
                ...
                vertex_lon = center_lon + pentagon_radius * math.cos(angle) / lat_correction
