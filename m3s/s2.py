...
class S2Grid(BaseGrid):
        ...
        try:
            ...
            for i in range(4):
                ...
                if neighbor_id is not None:
                    ...
                    neighbors.append(GridCell(neighbor_token, neighbor_polygon, self.level))
            ...
            for i in range(4):
                ...
                for vertex_neighbor_id in vertex_neighbors:
                    if vertex_neighbor_id is not None and vertex_neighbor_id.level() == self.level:
                        # Avoid duplicates
            ...
            warnings.warn(f"Failed to get neighbors: {e}")
            return []
    ...
    def get_children(self, cell: GridCell) -> List[GridCell]:
        ...
        try:
            ...
            warnings.warn(f"Failed to get children: {e}")
            return []
    ...
    def get_parent(self, cell: GridCell) -> Optional[GridCell]:
        ...
        try:
            ...
            warnings.warn(f"Failed to get parent: {e}")
            return None
    ...
    def get_cells_in_bbox(self, min_lat: float, min_lon: float,
        ...
        try:
            ...
            warnings.warn(f"Failed to get cells in bbox using s2sphere: {e}")
            return []
    ...
    def get_covering_cells(self, polygon: Polygon, max_cells: int = 100) -> List[GridCell]:
        ...
        try:
            ...
            warnings.warn(f"Failed to get covering cells: {e}")
