...
// (window.__M3S__.cs_cells_in_bbox), so the browser and the Python package
// produce identical C-square cells. Rings are closed [lon, lat]; the duplicate
...
window.__GRID__ = {
  ...
  cells: function (p, b) {
    return window.__M3S_CELLS__(window.__M3S__.cs_cells_in_bbox(b.s, b.w, b.n, b.e, p)).map(function (c) {
