...
GIS-native ``(lon, lat)`` coordinate order. The example first renders a static
basemap image and then the same cells on an interactive Leaflet map.
"""
...
gdf_web.plot(ax=ax, facecolor="#E69F00", edgecolor="black", linewidth=0.4, alpha=0.45)
