...
from m3s import (
    GeohashGrid, H3Grid, QuadkeyGrid, What3WordsGrid,
    convert_cell, create_conversion_table, list_grid_systems,
    analyze_relationship, find_adjacent_cells, create_adjacency_matrix,
    create_multiresolution_grid, create_adaptive_grid
)
...
def create_visualization_example():
    ...
    if len(h3_cells) > 1:
        ...
        for i, cell1 in enumerate(sample_cells):
            for j, cell2 in enumerate(sample_cells[i+1:], i+1):
