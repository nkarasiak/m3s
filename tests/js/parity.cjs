...
const FNS = {
  ...
  rhealpix: {
    point: wasm.rhp_cell_from_point,
    fromId: wasm.rhp_cell_from_id,
    neighbors: wasm.rhp_neighbors,
    children: wasm.rhp_children,
    parent: wasm.rhp_parent,
  },
  mgrs: {
...
const BBOX_FNS = {
  ...
  rhealpix: wasm.rhp_cells_in_bbox,
